...
def init_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default="ocr_block/deploy_model/Det")
    parser.add_argument("--det_limit_side_len", type=float, default=1920)
    parser.add_argument("--det_limit_type", type=str, default='max')

    # DB parmas
    parser.add_argument("--det_db_thresh", type=float, default=0.25)
    ...
    parser.add_argument("--rec_model_dir", type=str, default="ocr_block/deploy_model/Rec_iupac")
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default="ocr_block/ppocr/utils/en_dict.txt")

     # params for text recognizer crnn
    # parser.add_argument("--rec_algorithm", type=str, default='CRNN')
    # # parser.add_argument("--rec_model_dir", type=str)
    # parser.add_argument("--rec_model_dir", type=str)
    # # parser.add_argument("--rec_model_dir", type=str)
    # parser.add_argument("--rec_image_shape", type=str, default="3, 32, 320")
    # parser.add_argument("--rec_char_type", type=str)
    # parser.add_argument("--rec_batch_num", type=int, default=1)
    # parser.add_argument("--max_text_length", type=int, default=64)
    # parser.add_argument(
    #     "--rec_char_dict_path",
    #     type=str,
    #     default="./ppocr/utils/patent_dict_v2.txt")
